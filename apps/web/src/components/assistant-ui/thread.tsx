...
const ThreadSuggestionItem: FC<{ suggestion: QuickPrompt }> = ({
  suggestion,
}) => {
  const aui = useAui();
...
const AssistantActionBar: FC = () => {
  return (
    ...
    >
      ...
      <ActionBarPrimitive.Reload render={<TooltipIconButton tooltip="重试" />}><RefreshCwIcon /></ActionBarPrimitive.Reload>
...
const BranchPicker: FC<BranchPickerPrimitive.Root.Props> = ({
  ...
  return (
    <BranchPickerPrimitive.Root
      ...
      {...rest}
    >
      <BranchPickerPrimitive.Previous render={<TooltipIconButton tooltip="上一条" />}><ChevronLeftIcon /></BranchPickerPrimitive.Previous>
      <span className="aui-branch-picker-state font-medium">
        <BranchPickerPrimitive.Number /> / <BranchPickerPrimitive.Count />
      </span>
      <BranchPickerPrimitive.Next render={<TooltipIconButton tooltip="下一条" />}><ChevronRightIcon /></BranchPickerPrimitive.Next>
    </BranchPickerPrimitive.Root>
  );
};
